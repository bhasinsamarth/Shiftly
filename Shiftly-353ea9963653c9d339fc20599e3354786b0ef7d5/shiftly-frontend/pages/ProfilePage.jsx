...
const ProfilePage = () => {
  ...
  const handlePhotoChange = async (e) => {
    ...
    const oldPath = employeeData?.profile_photo_path;
    if (
      oldPath &&
      !oldPath.includes('matthew-blank-profile-photo-2.jpg') &&
      oldPath !== path // avoid deleting newly uploaded file in retry scenarios
    ) {
      ...
      <div className="flex flex-col items-center mb-8">
        <label htmlFor="upload-photo" className="cursor-pointer flex flex-col items-center">
          <div className="w-32 h-32 rounded-full overflow-hidden bg-gray-200">
            <img
              src={photoUrl || 'https://naenzjlyvbjodvdjnnbr.supabase.co/storage/v1/object/public/profile-photo//matthew-blank-profile-photo-2.jpg'}
              alt="Profile"
